...
const QString BITCOIN_IPC_PREFIX("antibandera:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/antibandera-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/antibandera-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/antibandera-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click antibandera: links
...
//
// OSX-specific way of handling antibandera: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in antibandera: URIs
